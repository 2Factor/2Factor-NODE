...
var SMSOTPController = {
     ...
     */
    getCheckSMSBalance : function(apiKey, callback){
        ...
        var queryBuilder = baseUri + "/API/V1/{api_key}/BAL/SMS";
     ...
     */
    getSendingSMSOTPAutoGeneratedOTP : function(apiKey, phoneNumber, callback){
        //Assign default values
        apiKey = apiKey || "Get one from http://2Factor.in";
        ...
        var queryBuilder = baseUri + "/API/V1/{api_key}/SMS/{phone_number}/AUTOGEN";
     ...
     */
    getSendingSMSOTPCustomOTP : function(apiKey, otp, phoneNumber, callback){
        //Assign default values
        apiKey = apiKey || "Get one from http://2Factor.in";
        otp = otp || "4499";
        phoneNumber = phoneNumber || "9911991199";
        ...
        var queryBuilder = baseUri + "/API/V1/{api_key}/SMS/{phone_number}/{otp}";
     ...
     */
    getVerifySMSOTPInput : function(apiKey, otpInput, sessionId, callback){
        //Assign default values
        apiKey = apiKey || "Get one from http://2Factor.in";
        ...
        var queryBuilder = baseUri + "/API/V1/{api_key}/SMS/VERIFY/{session_id}/{otp_input}";
...
module.exports = SMSOTPController;